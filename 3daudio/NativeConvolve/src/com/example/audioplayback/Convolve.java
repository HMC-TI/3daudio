...
public class Convolve extends Thread {
	...
	double[] xOld = new double[time_samples];
	double[] x = new double[time_samples];
	double[] y = new double[time_samples];
	public double[] out = new double[time_samples];
	
	
	
	Convolve(double[] xOld, double[] x, double[] y){
		// Constructor
		this.xOld = xOld;
		this.x = x;
		this.y = y;
