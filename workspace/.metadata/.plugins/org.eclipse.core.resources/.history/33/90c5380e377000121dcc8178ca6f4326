...
public class Audio3D {
	 ...
	 * New variables
	 ******************************************************/
	static float[][] irfBufR = new float [2][time_samples];
	static float[][] oldIrfR = new float [2][time_samples];
	/*******************************************************/
	 ...
	 */
	static void createOldConvolveAndCrossfade() {
	...
	static void crossfade(float[] newIn, float[] oldIn, float[] out){
